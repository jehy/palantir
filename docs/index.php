...
if((isset($from))&&(isset($rand)))//perehod
{
  ...
  if(mysql_num_rows($result))
  {
    ...
    ?><!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN"><html><head><STYLE TYPE="text/css">body{background-color : 6F7F8F;}A:visited{COLOR : white;}A:link{COLOR : white;}</style>
<LINK REL="SHORTCUT ICON" HREF="<?=COMMON_URL;?>favicon.ico">
<meta http-equiv="Content-Type" content="text/html; charset=utf-8">
<META http-equiv="refresh" content="2; URL=<?=$row['url'];?>"></head><body><div align="center">
...
Если этого не случилось - нажмите <a href="<?=$row['url']?>">на эту ссылку.</a></div>
  ...
  else $page='index';//if we dunno where to go^^
}
...
########################
#######################
function index($str,$arr){foreach($arr as $key=>$val)if($val==$str)return $key;return -1;}

if(@$ac=='login'){if((!$our_user)&&(!$admin_user))$page='login';else $page='user';}
