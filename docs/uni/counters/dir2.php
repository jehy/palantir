<?
$exc = array(
    '2_1.png', '2_2.png', '3_1.png', '3_2.png', '5_1.png', '5_2.png', '5_3.png',
...
#        if($line=='2_1.png')print_r($exc);
            ...
            if (($line != '.') and ($line != '..') and ($line != '')) {
                if (!$images) $images = $line; else $images .= '|' . $line;
            }
        }
    }
    $x .= $images;
...
echo_dir_filenames('uni/counters/standard');
$x .= '/';
echo_dir_filenames('uni/counters/numeric');
$x .= '/';
echo_dir_filenames('uni/counters/hit');
?>
